    ...
    steps: [
      {
        ...
        hint: 'Start with the school-wide health signal (Academic 78.6%, Attendance 91.8%). Identify the High Risk Alert notifying 84 students require intervention.',
      },
      {
        route: '/students/risk',
      ...
      },
      {
        ...
        hint: 'Inspect Riya Sharma’s profile. Notice why she is flagged HIGH RISK (68% Attendance, 54% Homework, 72.0 Performance).',
      },
      {
        route: '/students/class?from=student-riya',
        title: 'Class 8-A Intelligence',
        subtitle: 'Class Health & Multi-Class Comparison',
        hint: 'Bridge Riya to her class section (Class 8-A). See Class Growth +8.4% and assigned master teacher Priya Sharma.',
      },
      {
        route: '/teachers/teacher-1?from=class-8A',
        title: 'Priya Sharma — Teacher Profile',
        subtitle: 'Rank #1 Performance Index & "Why #1" Analysis',
        hint: 'Understand why Priya Sharma ranks #1 (Index 91.4, Cohort Growth +11.4%). Review her 35/25/15/10/10/5 weighted model breakdown.',
      },
    ],
  },
  {
